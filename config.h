...
{
	"JetBrainsMono Nerd Font:size=1"
};
#endif // PANGO_PATCH
#if MANAGED_PATCH
...
char *colors[][2] = {
	/*               fg         bg       */
	[SchemeNorm] = { "#F8F8F2", "#22212C" },
	[SchemeSel]  = { "#22212C", "#8AFF80" },
	[SchemeOut]  = { "#ff0000", "#8AFF80" },
	#if BORDER_PATCH
	[SchemeBorder] = { "#22212C", "#84FFF3" },
	#endif // BORDER_PATCH
	#if MORECOLOR_PATCH
	[SchemeMid]  = { "#22212C", "#EDED7A" },
	#endif // MORECOLOR_PATCH
	#if HIGHLIGHT_PATCH || FUZZYHIGHLIGHT_PATCH
	[SchemeSelHighlight]  = { "#22212C", "#84FFF3" },
	[SchemeNormHighlight] = { "#F8F8F2", "#22212C" },
	#endif // HIGHLIGHT_PATCH | FUZZYHIGHLIGHT_PATCH
	#if HIGHPRIORITY_PATCH
